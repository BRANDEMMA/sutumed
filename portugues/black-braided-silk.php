...
<body>
	...
	<div class="contenedor-producto">
		...
		<div class="caracteristicas-producto">
			<h3><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Seda Preta Trançada &nbsp;&nbsp;<i class="fa fa-caret-left" aria-hidden="true"></i></h3>

			<div class="izq-producto">
				<h4>General<br><div class="linea1"></div></h4>
				<ul>
					<li>Sutura de seda não absorvível.</li>
					<li>Geralmente conhecido sob o nome comercial Perma-MÃO.</li>
					<li>Filamento trançado.</li>
					<li>Fez um nome para fibroina proteína orgânica.</li>
