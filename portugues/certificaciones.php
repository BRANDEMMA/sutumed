...
<body>
	...
	<div class="noticias-blanco">
		...
		<div class="texto-noticia2">
			<h3>Certificado de Vendas</h3>
			<!-- <p class="subtitulo">Santiago de chile - CHILE</p> -->

			<p>Nossos produtos atendem aos mais altos padrões de qualidade exigidos a nível mundial.<br><br>

			Eu prendi as Certificações de nossos produtos.<br><br>
