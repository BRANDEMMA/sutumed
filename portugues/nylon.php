	...
	<div class="contenedor-producto">
		...
		<div class="caracteristicas-producto">
			...
			<div class="izq-producto">
				...
				<ul>
					<li>Fio de náilon não absorvível.</li>
					<li>Geralmente conhecido sob o nome comercial Ethilon.</li>
					<li>Fio monofilamento.</li>
					<li>Sutura feita a partir de polímeros alifáticos de cadeia longa Nylon.</li>
