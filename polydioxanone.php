	...
	<div class="contenedor-producto">
		...
		<div class="caracteristicas-producto">
			...
			<div class="izq-producto">
				...
				<p>&#8226; Absorbable suture (polydioxanone).<br>
				&#8226; Generally known under the trade name PDS.<br>
				&#8226; Monofilament thread.<br>
				&#8226; Made of polyester polymer.<br>
				&#8226; The absorption of this suture is complete within 230 days being absorbed by hydrolysis.
				</p>

				<h4>Other features<br><div class="linea2"></div></h4>
				<p>&#8226; Polydioxanone thread available in violet color.<br>
				&#8226; Thread size: from 6/0 to 1 USP.<br>
