...
<body>
	...
	<div class="contenedor-producto">
		...
		<div class="caracteristicas-producto">
			<h3><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp; Acido Poliglicólico &nbsp;&nbsp;<i class="fa fa-caret-left" aria-hidden="true"></i></h3>

			<div class="izq-producto">
				<h4>General<br><div class="linea1"></div></h4>
				<ul>
					<li>Sutura absorbible (polyglactyn 910).</li>
					<li>Generalmente conocido bajo el nombre comercial de Vicryl.</li>
					<li>Hebra trenzada, monofilamento.</li>
					<li>Lactida sutura copolímero y glicólico recubiertas poliglactina 370 y estearato de calcio.</li>
					<li>La absorción de esta sutura es completa dentro de los 70 días de ser absorbida por hidrólisis.</li>
				</ul>

				<h4>Otras características<br><div class="linea2"></div></h4>
				<ul>
					<li>Hilo de ácido poliglicólico en el color violeta.</li>
					<li>Tamaño de 10/0 al 1 USP.</li>
					<li>Esterilizados con óxido de etileno.</li>
					<li>Cajas por 12 o 36 unidades.</li>
				</ul>
			</div>
