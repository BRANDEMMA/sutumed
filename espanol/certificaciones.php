...
<body>
	...
	<div class="noticias-blanco">
		...
		<div class="texto-noticia2">
			<h3>Certificaciones de Venta</h3>
			<!-- <p class="subtitulo">Santiago de chile - CHILE</p> -->

			<p>Nuestros productos cumplen con los más altos estándares de calidad exigidos a nivel mundial.<br><br>

			Adjuntamos las certificaciones de nuestros productos.<br><br>
