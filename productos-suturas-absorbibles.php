...
?>
	<div class="contenedor-nuevos margen-superior">
		...
		<div class="nuevos-productos">
			<a href="chromic-catgut.php"><img src="img/producto-sutures.jpg"></a>
			<a href="chromic-catgut.php"><h4>Chromic Catgut</h4>
			<p>Absorbable suture</p></a>
		</div>

		<div class="nuevos-productos">
			<a href="polyglycolic-acid.php"><img src="img/producto-sutures.jpg"></a>
		...
		<div class="nuevos-productos">
			<a href="polydioxanone.php"><img src="img/producto-sutures.jpg"></a>
			<a href="polydioxanone.php"><h4>Polydioxanone</h4>
			<p>Absorbable suture (polydioxanone)</p></a>
		</div>

		<div class="nuevos-productos">
			<a href="polyglecaprone.php"><img src="img/producto-sutures.jpg"></a>
